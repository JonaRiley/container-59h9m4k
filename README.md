...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-59h9m4k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-59h9m4k.containers.anotherwebservice.com/
...
```
git clone git@github.com:JonaRiley/container-59h9m4k.git
cd container-59h9m4k
```
...
```
docker attach container-59h9m4k
```
